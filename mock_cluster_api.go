...
// PartitionDistribution provides a mock function with given fields: topic
func (_m *MockClusterAPI) PartitionDistribution(topic string) ([]TopicBrokerDistribution, error) {
	ret := _m.Called(topic)
